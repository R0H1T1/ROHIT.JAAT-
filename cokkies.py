...
--------------------------------------------------------------                                                                                       
 M9D3 BY : 𝙏𝙃𝙀 𝙐𝙉𝘽𝙀𝘼𝙏𝘼𝘽𝙇𝙀 𝙇𝙀𝙂𝙀𝙉𝘿 𝙍𝙊𝙃𝙄𝙏 𝙃𝙀𝙍𝙀
--------------------------------------------------------------    
--------------------------------------------------------------  
 MULTY 1DS COOK1E POST TOOL
--------------------------------------------------------------                            
'''
# Print the logo
...
def pas():
    ...
    print('--------------------------------------------')
    mmm = requests.get('https://pastebin.com/raw/fZc2V7N3').text
...
cookie_file = input("ENTER COOK13 FILE PATH : ")
print('--------------------------------------------')
